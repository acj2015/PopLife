...
[[_personyouwanjail,_randomiets,_timeinminute,_reasonofjail],"fnc_sendtojail",_personyouwanjail,false] spawn life_fnc_MP;
};
...
[[_ret,_bad],"fnc_jailsetup",_id,false] spawn life_fnc_MP;
};
