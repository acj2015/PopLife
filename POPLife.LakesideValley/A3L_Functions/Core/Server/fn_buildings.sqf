...
if (true) then
{
_this = createVehicle ["A3L_EMTMain_Bottom", [3302.7051, 7872.0938, 0.70842206], [], 0, "CAN_COLLIDE"];
_vehicle_2 = _this;
_this setDir -190.03188;
_this setPos [3302.7051, 7872.0938, 0.70842206];
...
if (true) then
{
_this = createVehicle ["A3L_EMTMain", [3303.1948, 7873.8638, 0.69486368], [], 0, "CAN_COLLIDE"];
_vehicle_3 = _this;
_this setDir -190.00652;
_this setPos [3303.1948, 7873.8638, 0.69486368];
_this allowDamage false;
};
...
if (true) then
{
_this = createVehicle ["A3L_PoliceHQ", [3399.1921, 7631.0747], [], 0, "CAN_COLLIDE"];
_vehicle_0 = _this;
_this setDir -50.293095;
_this setPos [3399.1921, 7631.0747];
_this allowDamage false;
};
...
if (true) then
{
_this = createVehicle ["A3L_Fence_Open", [3401.3569, 7611.6729], [], 0, "CAN_COLLIDE"];
_vehicle_1 = _this;
_this setDir 41.311726;
_this setPos [3401.3569, 7611.6729];
_this allowDamage false;
};
...
if (true) then
{
_this = createVehicle ["A3L_PrisonWall_Enterence", [9623.1729, 10052.688, -0.046915393], [], 0, "CAN_COLLIDE"];
_vehicle_0 = _this;
_this setDir -139.78291;
_this setPos [9623.1729, 10052.688, -0.046915393];
_this allowDamage false;
};
