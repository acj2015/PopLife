...
switch (_var) do
{
	...
	case "life_inv_uraniumu": {"Dechet d uranium"};
	case "life_inv_uraniump": {"Barre d uranium"};	
	...
	case "life_inv_lockpick": {"Force serrure"};	
	...
	case "life_inv_barrierCop": {"Barriere"};	
	...
	case "life_inv_opium": {"Fleur de pavot"};
	...
	case "life_inv_pavotseeds": {"Graine de pavot"};
	case "life_inv_cocaseeds": {"Graine de coca"};	
	...
	case "life_inv_RoadConeStripB": {"Cone raye clignotant"};
	case "life_inv_RoadConeB": {"Cone clignotant"};
	case "life_inv_RoadConeStrip": {"Cone raye"};
	case "life_inv_RoadCone": {"Cone"};
	...
	case "life_inv_BarGate": {"Barriere Police"};
	...
	case "license_civ_uranium": {"Physicien nucleaire"};
	case "license_civ_depan": {"License EASY-DEPAN"};
