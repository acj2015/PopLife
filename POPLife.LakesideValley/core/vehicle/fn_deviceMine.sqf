...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","corn_1","corn_2","bean_1","bean_2","cotton_1","olive_1","wheat_1","wheat_2","heroin_1","heroin_2","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","radZoneMarker"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["corn_1","corn_2","bean_1","bean_2","cotton_1","olive_1"]): {"peach"};
	case (_zone in ["heroin_1","heroin_2"]): {"heroinu"};
	case (_zone in ["cocaine_1"]): {"cocaine"};	
	case (_zone in ["pumpkin_1"]): {"pumpkin"};
	...
	case (_zone in ["radZoneMarker"]): {"uraniumu"};
	default {""};
};
