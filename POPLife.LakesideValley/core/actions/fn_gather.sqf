...
_resourceZones = ["wheat_1","wheat_2","sunflower_1","sunflower_2","corn_1","bean_1","corn_2","bean_2","cotton_1","olive_1","heroin_1","heroin_2","cocaine_1","cannabis_1","pumpkin_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["heroin_1"]): {_gather = "pavot Plant"; _seeds = "pavot seed"; _val = 1;};
	case (_zone in ["heroin_2"]): {_gather = "pavot Plant"; _seeds = "pavot seed"; _val = 1;};		
...
["Demasiado cerca de otra planta",20,"red"] call A3L_Fnc_Msg;
life_action_inUse = false;
} else {
if(!([false,_seeds,1] call life_fnc_handleInv)) exitWith {
["Usted tiene que comprar las semillas en la granja o en el mercado negro.",20,"red"] call A3L_Fnc_Msg;
life_action_inUse = false;
};
_plantedtext = format["Plantaste algunos %1",_gather];
[_plantedtext,20,"blue"] call A3L_Fnc_Msg;
